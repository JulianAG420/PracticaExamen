...
class AppStateNotifier extends ChangeNotifier {
  PracticaExamenFirebaseUser? initialUser;
  PracticaExamenFirebaseUser? user;
  ...
  void update(PracticaExamenFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              asyncParams: {
                'categoria':
                    getDoc(['Categorias'], CategoriasRecord.serializer),
              },
